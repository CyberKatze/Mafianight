      ...
      <nav className="border-gray-200 px-4 lg:px-6 py-2.5 bg-darkgray">
        <div className="flex flex-wrap justify-between items-center mx-auto  relative lg:static">
          ...
          <div className="flex items-center lg:order-2">
            ...
            onClick={toggleMenu}
            type="button" 
            className="inline-flex items-center p-2 ml-1 text-sm text-gray-400 rounded-lg lg:hidden hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-600" 
        ...
        <div className={`justify-between items-center w-full lg:flex lg:w-auto absolute top-full lg:static bg-slate lg:bg-transparent lg:order-1 ${isMenuOpen ? 'block' : 'hidden'}`} id="mobile-menu-2">
