  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap justify-center">
        {currentIndex > 0 &&
          <button type="button"
            className="bg-gradient-to-l from-red to-maroon hover:from-rosewater hover:to-rosewater text-text-inverted font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
